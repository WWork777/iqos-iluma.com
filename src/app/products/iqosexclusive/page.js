...
export async function generateMetadata() {
  const title =
    "Забронироватьустройства IQOS ILUMA в IqosIluma с доставкой по России";
  return {
    title,
    description:
    ...
    openGraph: {
      title: `Забронироватьлимитированные устройства IQOS ILUMA в IqosIluma с доставкой по России`,
